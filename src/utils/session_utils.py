"""
Модуль для управления сессиями пользователей и состояниями разговоров.
Предоставляет функции для работы с данными сессий, сохранения состояний между сообщениями.
"""
